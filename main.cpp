...
int main()
{
    ...
    lightingShader.loadShaders("Shaders/vertex_shader.glsl", "Shaders/fragment_shader.glsl");


    ShaderProgram lampShader;
    lampShader.loadShaders("Shaders/vertex_shader.glsl", "Shaders/lamp_fragment.glsl");
